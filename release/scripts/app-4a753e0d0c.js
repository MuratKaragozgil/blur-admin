...
(function() {
    ...
    function routeConfig($stateProvider, $urlRouterProvider) {
        $stateProvider
            ...
            resolve: {
                activityList: ["restService", function (restService) {
...
(function() {
    ...
    function routeConfig($stateProvider, $urlRouterProvider) {
        $stateProvider
            ...
            resolve: {
                siparisList: ["restService", function (restService) {
...
(function () {
    ...
    ActivityCreateCtrl.$inject = ["$scope", "restService", "$state", "constantService", "toastr", "$uibModal"];
    angular.module('BlurAdmin.pages.activity')
    ...
    function ActivityCreateCtrl($scope, restService, $state, constantService, toastr, $uibModal) {
        ...
        ContentDialogController.$inject = ["$scope", "$uibModalInstance", "constantService"];
...
(function () {
    ...
    function ActivityCtrl() {
        ...
        console.log("ActivityCtrl.js::invoked!");
...
(function () {
    ...
    ActivityListCtrl.$inject = ["$scope", "restService", "$state", "activityList"];
    angular.module('BlurAdmin.pages.activity')
...
(function () {
    ...
    ArticleCreateCtrl.$inject = ["$scope", "restService", "$state", "constantService", "toastr", "$uibModal"];
    angular.module('BlurAdmin.pages.article')
...
(function () {
    ...
    function ArticleCtrl() {
        ...
        console.log("ArticleCtrl::invoked!");
...
(function () {
    ...
    ArticleListCtrl.$inject = ["$scope", "restService", "$state"];
    angular.module('BlurAdmin.pages.article')
...
(function () {
    ...
    authSignInCtrl.$inject = ["$scope", "localStorage", "$state", "$http", "toastr", "restService"];
    angular.module('BlurAdmin.pages.authSignIn')
...
(function() {
  ...
  stateChangeStart.$inject = ["$rootScope", "$state", "localStorage"];
  angular.module('BlurAdmin.pages.config')
...
(function () {
    ...
    restService.$inject = ["$http", "nmUtils", "localStorage"];
    angular.module('BlurAdmin.pages.services')
...
(function () {
    ...
    QRCodeCtrl.$inject = ["$scope", "restService", "$state"];
    angular.module('BlurAdmin.pages.siparis')
...
(function () {
    ...
    SiparisListCtrl.$inject = ["$scope", "restService", "$state", "siparisList", "$window"];
    angular.module('BlurAdmin.pages.siparis')
    ...
    function SiparisListCtrl($scope, restService, $state, siparisList, $window) {
        ...
        function prepareFrame(src) {
            ...
            ifrm.setAttribute("name", "printf");
            ifrm.style.width = "640px";
            ifrm.style.height = "480px";
            ifrm.style.display = "none";
            ifrm.onload = iframeDidLoad();
...
angular.module('BlurAdmin').run(['$templateCache', function($templateCache) {$templateCache.put('app/pages/activity/activity-create.html','<div ba-panel="" ba-panel-title="" ba-panel-class="with-scroll"><form><div class="form-group"><label for="title">Title</label> <input type="text" class="form-control" id="title" placeholder="Title" ng-model="activity.title"></div><div class="form-group"><label for="subTitle">Sub Title</label> <input type="text" class="form-control" id="subTitle" placeholder="Sub Title" ng-model="activity.subTitle"></div><div class="form-group"><label for="subTitle">Materials</label> <input type="text" class="form-control" id="materials" placeholder="Materials" ng-model="activity.materials"></div><div class="form-group"><label for="interval">Interval</label> <input type="text" class="form-control" id="interval" placeholder="4-6" ng-model="activity.interval"></div><div class="form-group"><label for="categoryIds">Category</label><ui-select multiple="" ng-model="activity.categoryIds" class="form-control" ng-disabled="false" id="categoryIds" append-to-body="true" search-enabled="true"><ui-select-match placeholder="Select Category IDs"><span>{{$item.name}}</span></ui-select-match><ui-select-choices repeat="category in catalogCategories | filter: $select.search"><span ng-bind-html="category.name"></span></ui-select-choices></ui-select></div><div class="form-group"><label for="description">Description</label> <textarea placeholder="Description" class="form-control" id="description" ng-model="activity.description"></textarea></div><div class="form-group"><label><b>Contents</b></label><div class="warning" ng-if="activity.content.length === 0">There are no content yet!</div><div class="horizontal-scroll" ng-if="activity.content.length !== 0"><table class="table"><thead><tr><th class="align-right">Type</th><th class="align-right">Punto</th><th class="align-right">Style</th><th class="align-right">Align</th><th class="align-right">Text Value</th><th class="align-right">Image Value</th><th class="align-right">Url Value</th></tr></thead><tbody><tr ng-repeat="content in activity.content"><td class="align-right">{{content.type}}</td><td class="align-right">{{content.punto}}</td><td class="align-right">{{content.style}}</td><td class="align-right">{{content.align}}</td><td class="align-right"><select><option ng-repeat="x in content.textValue">{{x}}</option></select></td><td class="align-right"><select><option ng-repeat="x in content.imageValue">{{x}}</option></select></td><td class="align-right"><select><option ng-repeat="x in content.urlValue">{{x}}</option></select></td></tr></tbody></table></div><div class="align-right"><button type="button" class="btn btn-danger" data-toggle="modal" ng-click="open(\'app/pages/ui/modals/modalTemplates/contentModal.html\', \'lg\')">Add Content</button></div></div><div class="align-right"><button type="button" class="btn btn-primary btn-raised btn-lg" ng-click="save()">Save</button></div></form></div>');
$templateCache.put('app/pages/activity/activity-list.html','<div class="row"><div class="col-md-12"><div class="align-right"><button type="button" class="btn btn-primary btn-raised" ng-click="createArticle()">Create Activity</button></div></div></div><div class="row" style="padding-top: 5px"><div class="col-md-12"><div ba-panel="" ba-panel-class="with-scroll"><div class="horizontal-scroll"><table class="table table-hover"><thead><tr class="black-muted-bg"><th>ID</th><th class="col-md-2">Title</th><th class="col-md-2">Sub Title</th><th class="col-md-5">Description</th><th>Materials</th><th>Interval</th><th>Action</th></tr></thead><tbody><tr ng-repeat="item in activityTableData" class="no-top-border"><td>{{item.id}}</td><td class="col-md-2">{{item.title}}</td><td class="col-md-2">{{item.subTitle}}</td><td class="col-md-5">{{item.description}}</td><td>{{item.materials}}</td><td>{{item.interval}}</td><td><i class="ion-trash-a" ng-click="deleteActivity(item.id, $index)"></i></td></tr></tbody></table></div></div></div></div>');
$templateCache.put('app/pages/article/article-create.html','<div ba-panel="" ba-panel-title="" ba-panel-class="with-scroll"><form><div class="form-group"><label for="title">Title</label> <input type="text" class="form-control" id="title" placeholder="Title" ng-model="article.title"></div><div class="form-group"><label for="author">Author</label> <input type="text" class="form-control" id="author" placeholder="Author" ng-model="article.author"></div><div class="form-group"><label for="interval">Interval</label><ui-select ng-model="article.interval" class="btn-group bootstrap-select form-control" ng-disabled="false" id="interval" append-to-body="true" search-enabled="true"><ui-select-match placeholder="Select Interval"><span>{{article.interval.label}}</span></ui-select-match><ui-select-choices repeat="interval in intervals | filter: $select.search"><span ng-bind-html="interval.label"></span></ui-select-choices></ui-select></div><div class="form-group"><label for="categoryIds">Category</label><ui-select multiple="" ng-model="article.categoryIds" class="form-control" ng-disabled="false" id="categoryIds" append-to-body="true" search-enabled="true"><ui-select-match placeholder="Select Category IDs"><span>{{$item.name}}</span></ui-select-match><ui-select-choices repeat="category in catalogCategories | filter: $select.search"><span ng-bind-html="category.name"></span></ui-select-choices></ui-select></div><div class="form-group"><label for="description">Description</label> <textarea placeholder="Description" class="form-control" id="description" ng-model="article.description"></textarea></div><div class="form-group"><label><b>Contents</b></label><div class="warning" ng-if="article.content.length === 0">There are no content yet!</div><div class="horizontal-scroll" ng-if="article.content.length !== 0"><table class="table"><thead><tr><th class="align-right">Type</th><th class="align-right">Punto</th><th class="align-right">Style</th><th class="align-right">Align</th><th class="align-right">Text Value</th><th class="align-right">Image Value</th><th class="align-right">Url Value</th></tr></thead><tbody><tr ng-repeat="content in article.content"><td class="align-right">{{content.type}}</td><td class="align-right">{{content.punto}}</td><td class="align-right">{{content.style}}</td><td class="align-right">{{content.align}}</td><td class="align-right"><select><option ng-repeat="x in content.textValue">{{x}}</option></select></td><td class="align-right"><select><option ng-repeat="x in content.imageValue">{{x}}</option></select></td><td class="align-right"><select><option ng-repeat="x in content.urlValue">{{x}}</option></select></td></tr></tbody></table></div><div class="align-right"><button type="button" class="btn btn-danger" data-toggle="modal" ng-click="open(\'app/pages/ui/modals/modalTemplates/contentModal.html\', \'lg\')">Add Content</button></div></div><div class="align-right"><button type="button" class="btn btn-primary btn-raised btn-lg" ng-click="save()">Save</button></div></form></div>');
$templateCache.put('app/pages/article/article-list.html','<div class="row"><div class="col-md-12"><div class="align-right"><button type="button" class="btn btn-primary btn-raised" ng-click="createArticle()">Create Article</button></div></div></div><div class="row" style="padding-top: 5px"><div class="col-md-12"><div ba-panel="" ba-panel-class="with-scroll"><div class="horizontal-scroll"><table class="table table-hover"><thead><tr class="black-muted-bg"><th>ID</th><th>Title</th><th>Description</th><th>Author</th><th>Create Date</th></tr></thead><tbody><tr ng-repeat="item in articleTableData" class="no-top-border"><td>{{item.id}}</td><td>{{item.title}}</td><td>{{item.description}}</td><td>{{item.author}}</td><td>{{item.createDate}}</td></tr></tbody></table><div class="align-right" ng-if="bigTotalItems > itemsPerPage"><ul uib-pagination="" total-items="bigTotalItems" items-per-page="itemsPerPage" ng-model="bigCurrentPage" max-size="maxSize" class="pagination-sm align-right" boundary-links="true" num-pages="numPages"></ul></div></div></div></div></div>');
$templateCache.put('app/pages/authSignIn/authSignIn.html','<div class="login" ng-controller="authSignInCtrl as signInVm"><main class="auth-main"><div class="auth-block"><h1>Sign in to Barcode Dashboard</h1><form class="form-horizontal" ng-submit="signInVm.login()"><div class="form-group"><label for="inputEmail3" class="col-sm-2 control-label">Email</label><div class="col-sm-10"><input type="email" ng-model="signInVm.username" class="form-control" id="inputEmail3" placeholder="Email" value="m.karagozgil@gmail.com"></div></div><div class="form-group"><label for="inputPassword3" class="col-sm-2 control-label">Password</label><div class="col-sm-10"><input type="password" ng-model="signInVm.password" class="form-control" id="inputPassword3" placeholder="Password" value="murat"></div></div><div class="form-group"><div class="col-sm-offset-2 col-sm-10"><button type="submit" class="btn btn-default btn-auth">Sign in</button> <a href="" class="forgot-pass">Forgot password?</a></div></div></form><div class="auth-sep"><span><span>or Sign in with one click</span></span></div><div class="al-share-auth"><ul class="al-share clearfix"><li><i class="socicon socicon-facebook" title="Share on Facebook"></i></li><li><i class="socicon socicon-twitter" title="Share on Twitter"></i></li><li><i class="socicon socicon-google" title="Share on Google Plus"></i></li></ul></div></div></main></div>');
$templateCache.put('app/pages/authSignUp/authSignUp.html','<div class="login"><main class="auth-main"><div class="auth-block"><h1>Sign up to Blur Admin</h1><a ui-sref="authSignIn" class="auth-link">Already have a Blur Admin account? Sign in!</a><form class="form-horizontal"><div class="form-group"><label for="inputName3" class="col-sm-2 control-label">Name</label><div class="col-sm-10"><input type="text" class="form-control" id="inputName3" placeholder="Full Name"></div></div><div class="form-group"><label for="inputEmail3" class="col-sm-2 control-label">Email</label><div class="col-sm-10"><input type="email" class="form-control" id="inputEmail3" placeholder="Email"></div></div><div class="form-group"><label for="inputPassword3" class="col-sm-2 control-label">Password</label><div class="col-sm-10"><input type="password" class="form-control" id="inputPassword3" placeholder="Password"></div></div><div class="form-group"><div class="col-sm-offset-2 col-sm-10"><button type="submit" class="btn btn-default btn-auth">Sign up</button></div></div></form><div class="auth-sep"><span><span>or Sign up with one click</span></span></div><div class="al-share-auth"><ul class="al-share clearfix"><li><i class="socicon socicon-facebook" title="Share on Facebook"></i></li><li><i class="socicon socicon-twitter" title="Share on Twitter"></i></li><li><i class="socicon socicon-google" title="Share on Google Plus"></i></li></ul></div></div></main></div>');
...
$templateCache.put('app/pages/main/main.html','<div class="body-bg"></div><main ng-if="$pageFinishedLoading" ng-class="{ \'menu-collapsed\': $baSidebarService.isMenuCollapsed() }"><ba-sidebar></ba-sidebar><page-top></page-top><div class="al-main"><div class="al-content"><content-top></content-top><div ui-view="" autoscroll="true" autoscroll-body-top=""></div></div></div><footer class="al-footer clearfix"><div class="al-footer-right">Created with <i class="ion-heart"></i></div><div class="al-footer-main clearfix"><div class="al-copy">Barcode 2016</div><ul class="al-share clearfix"><li><i class="socicon socicon-facebook"></i></li><li><i class="socicon socicon-twitter"></i></li><li><i class="socicon socicon-google"></i></li><li><i class="socicon socicon-github"></i></li></ul></div></footer><back-top></back-top></main><div id="preloader" ng-show="!$pageFinishedLoading"><div></div></div>');
...
$templateCache.put('app/pages/siparis/print-qr-code.html','<div style="transform: rotate(-90deg);margin-left: 30px"><div id="qrcode"></div><div id="id"></div><div id="telefon"></div><div id="address"></div><div id="tarih"></div></div><script src="/app/pages/siparis/js/qr-code-min.js"></script><script type="text/javascript">\n    var url_string = window.location.href; //window.location.href\n    var url = new URL(url_string);\n    var c = url.searchParams.get("c");\n    var telefon = url.searchParams.get("telefon");\n    var id = url.searchParams.get("id");\n    var adress = url.searchParams.get("address");\n    var tarih = "2019-08-08 12-12";\n\n    document.getElementById("id").innerText = id;\n    document.getElementById("telefon").innerText = telefon;\n    document.getElementById("address").innerText = adress;\n    document.getElementById("tarih").innerText = tarih;\n\n    var qrcode = new QRCode(document.getElementById("qrcode"), {\n        text: c,\n        width: 75,\n        height: 75,\n        colorDark: "#000000",\n        colorLight: "#ffffff",\n        correctLevel: QRCode.CorrectLevel.H\n    });\n    window.print();\n</script><style>\n    @media print {\n        @page {\n            size: 75px 75px;\n            margin: 0;\n            padding: 0;\n        }\n\n        html, body {\n            position: relative;\n            width: 100%;\n            height: 100%;\n            max-width: 100%;\n            max-height: 97%;\n            margin: 0;\n            padding: 0;\n        }\n\n        svg {\n            width: 100%;\n            height: 100%;\n            max-width: 100%;\n            max-height: 100%;\n        }\n    }\n</style>');
$templateCache.put('app/pages/siparis/siparis-list.html','<div class="row"><div class="col-md-12"><div class="align-right"><button type="button" class="btn btn-primary btn-raised" ng-click="printAllSelected()">Print All Selected</button></div></div></div><div class="row" style="padding-top: 5px"><div class="col-md-12"><div ba-panel="" ba-panel-class="with-scroll"><div class="horizontal-scroll"><table class="table table-hover"><thead><tr class="black-muted-bg"><th>ID</th><th>Siparis Veren</th><th>E-Posta</th><th>Telefon</th><th>Odeme Tipi</th><th>Selection</th><th>Action</th></tr></thead><tbody><tr ng-repeat="item in siparisTableData" class="no-top-border"><td>{{item.id}}</td><td>{{item.siparis_veren_kisi}}</td><td>{{item.e_posta}}</td><td>{{item.telefon}}</td><td>{{item.odeme_tipi}}</td><td><input type="checkbox" id="checkboxSuccess" ng-click="checkBoxSelected(item)"></td><td><a ng-click="getQrCodeList([item.id])">Print</a></td></tr></tbody></table><script>\n                    function iframeDidLoad() {\n                        alert(\'Done\');\n                        window.frames["printf"].focus();\n                        window.frames["printf"].print();\n                    }\n                </script><iframe src="http://18.217.232.13/barcode/files/1565772493690.pdf" id="printf" name="printf" width="100%" height="100%" onload="iframeDidLoad()"></iframe></div></div></div></div>');
...
$templateCache.put('app/pages/ui/modals/modalTemplates/contentModal.html','<div class="modal-content"><div class="modal-header bg-success"><i class="ion-flame modal-icon"></i><span>Content</span></div><div class="modal-body"><div class="row form-control"><label class="col-md-2">Type</label><select ng-model="content.type" ng-change="contentTypeChanged()"><option ng-repeat="x in contentTypes" value="{{x.value}}">{{x.label}}</option></select></div><div class="row form-control" ng-if="content.type === \'TEXT\'"><label class="col-md-2">Punto</label> <input type="text" class="col-md-6" id="punto" placeholder="10" ng-model="content.punto"></div><div class="row form-control" ng-if="content.type === \'TEXT\'"><label class="col-md-2">Style</label> <input type="text" class="col-md-6" id="style" placeholder="10" ng-model="content.style"></div><div class="row"><div class="col-md-2"></div></div><div class="row form-control" ng-if="content.type === \'TEXT\'"><label class="col-md-2">Align</label> <input type="text" class="col-md-6" id="align" placeholder="10" ng-model="content.align"></div><div class="row"><div class="col-md-2"></div></div><div class="row form-control" ng-if="content.type === \'TEXT\'"><label class="col-md-2">Text</label> <input type="text" class="col-md-6" id="text" placeholder="text" ng-model="content.text"><div class="col-md-1"></div><button type="button" class="btn btn-primary btn-sm" ng-click="addValueToArray(content.textvalue, content.text)">Add</button><div class="col-sm-10" ng-repeat="text in content.textValue">{{text}}</div></div><div class="row form-control" ng-if="content.type === \'IMAGE\'"><label class="col-md-2">Image</label> <input type="text" class="col-md-6" id="Image" placeholder="text" ng-model="content.text"><div class="col-md-1"></div><button type="button" class="btn btn-primary btn-sm" ng-click="addValueToArray(content.text)">Add</button><div class="col-sm-10" ng-repeat="text in content.textValue">{{text}}</div></div><div class="row form-control" ng-if="content.type === \'LINK\'"><label class="col-md-2">Link</label> <input type="text" class="col-md-6" id="link" placeholder="text" ng-model="content.url"><div class="col-md-1"></div><button type="button" class="btn btn-primary btn-sm" ng-click="addValueToArray(content.urlValue, content.url)">Add</button><div class="col-sm-10" ng-repeat="text in content.textValue">{{text}}</div></div></div><div class="modal-footer"><button type="button" class="btn btn-danger" ng-click="cancel()">Cancel</button> <button type="button" class="btn btn-success" ng-click="save()">Save</button></div></div>');
...
//# sourceMappingURL=../maps/scripts/app-4a753e0d0c.js.map
