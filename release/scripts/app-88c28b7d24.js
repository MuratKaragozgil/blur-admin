...
(function () {
    ...
    function SiparisListCtrl($scope, restService, $state, siparisList, $window) {
        ...
        function prepareFrame(src) {
            ...
            ifrm.setAttribute("id", "printf" + frameId);
            ifrm.setAttribute("name", "printf" + frameId);
            ifrm.style.width = "640px";
            ifrm.style.height = "480px";
            ifrm.style.display = "none";
            ifrm.onload = function iframeDidLoad() {
                window.frames["printf" + frameId].focus();
                window.frames["printf" + frameId].print();
            };
...
//# sourceMappingURL=../maps/scripts/app-88c28b7d24.js.map
